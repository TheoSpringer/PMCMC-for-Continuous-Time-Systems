...
function expand_local_Jacobian_sparsity_pattern!(sparsity_global_Jacobian_rows::AbstractVector{<:Integer}, sparsity_global_Jacobian_columns::AbstractVector{<:Integer}, sparsity_local_Jacobian_rows::Vector{Int}, sparsity_local_Jacobian_columns::Vector{Int}, indices_h_global::Vector{UnitRange{Int}}, indices::OCPIndices, dimensions::OCPDimensions)
    ...
    for k in 1:dimensions.K
        ...
        for (r, c) in zip(sparsity_local_Jacobian_rows, sparsity_local_Jacobian_columns)
            ...
            global_column = translate_local_index_to_global(c, column_offset_X, column_offset_Y, dimensions, indices)
...
function setup_sparse_Jacobian_cache!(sparsity_global_Jacobian_rows::AbstractVector{<:Integer}, sparsity_global_Jacobian_columns::AbstractVector{<:Integer}, h!::Function, h_loc::AbstractVector, z_scenario::AbstractVector, indices_h_global::Vector{UnitRange{Int}}, indices::OCPIndices, dimensions::OCPDimensions)
    # Evaluate the sparsity pattern of the local Jacobian.
    ...
    nzrange_Jacobian_h = expand_local_Jacobian_sparsity_pattern!(sparsity_global_Jacobian_rows, sparsity_global_Jacobian_columns, sparsity_local_Jacobian_rows, sparsity_local_Jacobian_columns, indices_h_global, indices, dimensions)[1]
...
function compute_Hessian_sparsity(f::Function, z::AbstractVector)
    ...
    # Keep only the upper triangular part of the Hessian sparsity pattern.
    local_Hessian_sparsity = triu(local_Hessian_sparsity, 0)
...
function expand_local_Hessian_sparsity!(sparsity_global_Hessian_rows::AbstractVector{<:Integer}, sparsity_global_Hessian_columns::AbstractVector{<:Integer}, sparsity_local_Hessian_rows::Vector{Int}, sparsity_local_Hessian_columns::Vector{Int}, indices::OCPIndices, dimensions::OCPDimensions)
    ...
    for k in 1:dimensions.K
        ...
        for (r, c) in zip(sparsity_local_Hessian_rows, sparsity_local_Hessian_columns)
            # Translate the local row and column indices to the global index space.
            global_row = translate_local_index_to_global(r, offset_X, offset_Y, dimensions, indices)
            global_column = translate_local_index_to_global(c, offset_X, offset_Y, dimensions, indices)
...
function setup_sparse_Hessian_cache!(sparsity_global_Hessian_rows::AbstractVector{<:Integer}, sparsity_global_Hessian_columns::AbstractVector{<:Integer}, lagrangian::Function, z_scenario::AbstractVector, indices::OCPIndices, dimensions::OCPDimensions)
    # Evaluate the sparsity pattern of the local Jacobian.
    ...
    # Expand the local sparsity pattern of the dynamics constraints to the global index space.
    nzrange_Hessian_L = expand_local_Hessian_sparsity!(sparsity_global_Hessian_rows, sparsity_global_Hessian_columns, sparsity_local_Hessian_rows, sparsity_local_Hessian_columns, indices, dimensions)[1]
